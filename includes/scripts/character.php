...
if($_POST['action']=='unstuck') 
{
    ...
    if (character::isAccountCharacter($guid, $acct_id)==FALSE)
        die('<b class="red_text">That character does not belong to you.');
...
if ($_POST['action']=='teleport') 
{
    ...
    mysql_query("UPDATE characters SET position_x = ".$x.", position_y= ".$y.", position_z = ".$z.", map = ".$map." WHERE account = ".$acct_id." 
			     AND guid = '".$character."'");
